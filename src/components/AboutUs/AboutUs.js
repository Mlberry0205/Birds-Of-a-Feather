...
const AboutUs = () => {
  return (
    <div className='about-layout'>
      <p className='text'>
        Use this site to listen to the sounds of the bearded bellbird.The bearded bellbird can be found in Northern South America.  The male pictured is about 28 cm long with white plumage
